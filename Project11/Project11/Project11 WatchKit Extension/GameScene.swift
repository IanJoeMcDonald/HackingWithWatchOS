...
class GameScene: SKScene, WKCrownDelegate, SKPhysicsContactDelegate {
    ...
    var player = SKNode()
    var leftEdge = SKSpriteNode(color: .white, size: CGSize(width: 10, height: 174))
    var rightEdge = SKSpriteNode(color: .white, size: CGSize(width: 10, height: 174))
    var topEdge = SKSpriteNode(color: .white, size: CGSize(width: 154, height: 10))
    var bottomEdge = SKSpriteNode(color: .white, size: CGSize(width: 154, height: 10))
    ...
    func launchBall() {
        ...
        // get a random edge to launch from, plus a position and force to apply
